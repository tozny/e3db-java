...
* [6.0.1](https://tozny.github.io/e3db-java/docs/6.0.0/) - The most recently released version of the client.
...
implementation ('com.tozny.e3db:e3db-client-android:6.0.1@aar') {
    transitive = true
}
```
