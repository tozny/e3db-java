...
* [5.0.1](https://tozny.github.io/e3db-java/docs/5.0.1/) - The most recently released version of the client.
...
implementation ('com.tozny.e3db:e3db-client-android:5.0.1@aar') {
    transitive = true
}
```
