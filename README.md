...
* [7.1.1](https://tozny.github.io/e3db-java/docs/7.1.1/) - The most recently released version of the client.
...
implementation ('com.tozny.e3db:e3db-client-android:7.1.1@aar') {
    transitive = true
}
```
