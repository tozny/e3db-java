...
* [3.2.0-SNAPSHOT](https://tozny.github.io/e3db-java/docs/3.2.0-SNAPSHOT/) - The most recently released version of the client.
...
implementation ('com.tozny.e3db:e3db-client-android:3.2.0-SNAPSHOT@aar') {
    transitive = true
}
```
