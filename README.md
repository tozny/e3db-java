...
* [3.0.0](https://tozny.github.io/e3db-java/docs/3.0.0/) - The most recently released version of the client.
* Older versions: [2.3.0](https://tozny.github.io/e3db-java/docs/2.3.0/), [2.2.0](https://tozny.github.io/e3db-java/docs/2.2.0/), [2.0.0](https://tozny.github.io/e3db-java/docs/2.0.0/).
...
implementation ('com.tozny.e3db:e3db-client-android:3.0.0@aar') {
    transitive = true
}
```
