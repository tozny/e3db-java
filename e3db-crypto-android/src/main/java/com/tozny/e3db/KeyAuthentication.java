...
public abstract class KeyAuthentication {
  ...
  public enum KeyAuthenticationType {
    ...
    NONE,
    /**
     * Fingerprint authentication required. See "Requiring User Authentication For Key Use" on https://developer.android.com/training/articles/keystore.html
     * for details.
     */
    FINGERPRINT,
    /**
     * Lock scren PIN authentication required. See "Requiring User Authentication For Key Use" on https://developer.android.com/training/articles/keystore.html
     * for details.
     */
    LOCK_SCREEN,
    /**
   ...
   *
   * See "Requiring User Authentication For Key Use" on https://developer.android.com/training/articles/keystore.html
   * for details.
   * @return Ibid.
   */
